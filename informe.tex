...
\textbf{Abstraktor} es una implementación de esta estrategia en forma de herramienta de línea de comandos que automatiza la generación de EPAs para protocolos distribuidos implementados en C/C++. La herramienta integra diferentes componentes y aplicaciones en un flujo de trabajo unificado.
